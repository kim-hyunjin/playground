...
export const PARKS_2026: ParkProfile[] = [
  ...
  { abbr: 'WO', stadium: '고척 스카이돔', runFactor: 0.97, hrFactor: 0.93, dome: true },
  { abbr: 'KT', stadium: 'KT 위즈파크', runFactor: 1.0, hrFactor: 0.98 },
  { abbr: 'DS', stadium: '잠실 야구장', runFactor: 1.02, hrFactor: 1.01 },
  { abbr: 'LG', stadium: '잠실 야구장', runFactor: 1.02, hrFactor: 1.01 },
  { abbr: 'LT', stadium: '사직야구장', runFactor: 1.05, hrFactor: 1.06 },
  { abbr: 'HH', stadium: '대전 한화생명 이글스파크', runFactor: 0.98, hrFactor: 0.96 },
  { abbr: 'SS', stadium: '대구 삼성 라이온즈 파크', runFactor: 0.95, hrFactor: 0.93 },
]
