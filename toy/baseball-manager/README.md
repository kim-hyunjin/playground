...
- **라인업·로테이션** 편성
- **경기 시뮬레이션** — 아웃·주자·타구를 표시하는 2D 경기장 + 타석 단위 플레이
...
- 경기 전 공격·투구 작전을 선택하고 `경기 시작`을 누릅니다.
- 경기 중 `일시정지` 후 불펜, 대타, 대주자 교체를 지시할 수 있습니다.
- 재생 속도는 0.5×·1×·2×이며 애니메이션을 끌 수 있습니다. 운영체제의 reduced-motion 설정도 따릅니다.
