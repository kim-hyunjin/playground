  ...
  return (
    <div className="p-4 bg-white rounded-xl shadow-md">
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-xl font-bold text-gray-800">동적 막대 차트 (Dynamic Bar Chart)</h2>
        <button
      ...
      <p className="text-sm text-gray-600 mb-6">
        D3의 Transition 기능을 사용하여 데이터 변경 시 부드러운 애니메이션을 보여줍니다. 
        프로젝트의 실시간 모니터링 대시보드에서 데이터 변화를 직관적으로 전달할 때 유용합니다.
      </p>
